...
android {
    ...
    productFlavors {
        ...
        create("default") {
            ...
            applicationId = "chat.schildi.android"
            isDefault = true
            resValue("string", "sc_app_name", "CasaBlue")
            resValue("string", "sc_app_name_launcher", "CasaBlue")
        }
        create("beta") {
            dimension = "sc-variant"
            applicationId = "chat.schildi.next"
            resValue("string", "sc_app_name", "CasaBlue (Beta)")
            resValue("string", "sc_app_name_launcher", "CasaBlue β")
        }
        create("internal") {
            dimension = "sc-variant"
            applicationId = "chat.schildi.next.internal"
            resValue("string", "sc_app_name", "CasaBlue (Internal)")
            resValue("string", "sc_app_name_launcher", "CasaBlue[i]")
        }
    }
    // Build types to override some more upstream values
    buildTypes {
        named("debug") {
            resValue("string", "app_name", "CasaBlue dbg")
            buildConfigField("String", "SC_VERSION_MAIN", "\"$scVersionMain\"")
            buildConfigField("String", "SC_VERSION_ELEMENT", "\"${Versions.VERSION_NAME}\"")
        }
        named("release") {
            resValue("string", "app_name", "CasaBlue")
            buildConfigField("String", "SC_VERSION_MAIN", "\"$scVersionMain\"")
            buildConfigField("String", "SC_VERSION_ELEMENT", "\"${Versions.VERSION_NAME}\"")
        }
    }
