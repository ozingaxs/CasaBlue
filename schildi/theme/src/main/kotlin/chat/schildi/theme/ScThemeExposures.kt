...
class ScThemeExposures(
    ...
    var messageHighlightBg by mutableStateOf(messageHighlightBg)
        private set
    var timelineBg by mutableStateOf(timelineBg)
        private set
    ...
    fun copy(
        ...
        timelineBg: Color? = this.timelineBg,
...
internal val elementLightScExposures = ScThemeExposures(
    ...
    appBarBg = ScColors.colorNavyBlue,
    bubbleRadius = 12.dp,
    ...
    spaceBarBg = ScColors.colorNavyBlue,
