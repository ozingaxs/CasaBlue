...
internal object ScColors {
    ...
    val colorNavyBlue = Color(0xff000080)
    val colorPaleYellow = Color(0xfffff9e3)
    val colorFbYellow = Color(0xfffbed21)
}
...
object ScBrandingColors {
    val onboardingGradientLight = listOf(
        ScColors.colorNavyBlue, ScColors.colorNavyBlue
    )
    val onboardingGradientDark = listOf(
        ScColors.colorNavyBlue, ScColors.colorNavyBlue
    )
    val onboardingIconBgColors = listOf(
        ScColors.colorFbYellow, ScColors.colorNavyBlue
    )
    val onboardingLogoOutlineDark = ScColors.colorFbYellow
}
