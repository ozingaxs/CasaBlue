            ...
            aMessagesState(
                ...
                timelineState = aTimelineState(
                    ...
                    timelineItems = listOf(
                        ...
                        aTimelineItemEvent(
                            user = me,
                            content = aTimelineItemTextContent("Now, what is this CasaBlue? Can somebody explain?"),
                            groupPosition = TimelineItemGroupPosition.None,
                            sentTime = "8:50",
                        ),
                        aTimelineItemEvent(
                            user = bob,
                            content = aTimelineItemImageContent("mxc://real", "It's the post blue home that I send my Matrix messages with ^", w=750, h=500),
                        ...
                        aTimelineItemEvent(
                            user = bob,
                            content = aTimelineItemTextContent("Ah moment, it's based on Element X, the Matrix messenger. CasaBlue adds some nice features and UI changes to it 😉"),
