...
class NotificationSettingsPresenter(
    ...
    private fun probeSoundDisplayName(
        ...
        NotificationSound.ElementDefault -> stringProvider.getString(R.string.screen_notification_settings_sound_CasaBlue_default)
        NotificationSound.ElementFade -> stringProvider.getString(R.string.screen_notification_settings_sound_CasaBlue_fade)
