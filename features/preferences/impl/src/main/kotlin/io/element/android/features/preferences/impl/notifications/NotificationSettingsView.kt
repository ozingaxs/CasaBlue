...
private fun MessageSoundDialog(state: NotificationSettingsState) {
    ...
    SingleSelectionDialog(
        ...
        options = persistentListOf(
            ListOption(title = stringResource(id = R.string.screen_notification_settings_sound_CasaBlue_default)),
            ListOption(title = stringResource(id = R.string.screen_notification_settings_sound_CasaBlue_fade)),
