        ...
        is AsyncData.Failure -> {
            when (val error = state.changeServerAction.error as? ChangeServerError) {
                ...
                is ChangeServerError.NeedElementPro -> {
                    ConfirmationDialog(
                        modifier = modifier,
                        title = stringResource(R.string.screen_change_server_error_CasaBlue_pro_required_title),
                        content = stringResource(
                            R.string.screen_change_server_error_CasaBlue_pro_required_message,
                            error.unauthorisedAccountProviderTitle,
                        ),
                        submitText = stringResource(R.string.screen_change_server_error_CasaBlue_pro_required_action_android),
                        onSubmitClick = {
